...
<div class="eat-tab-content eat-tab-posts-and-pages-management" style="display: none;">
	<div class="eat-tab-content-header">
		<div class="eat-tab-content-header-title"><?php _e('Posts and Pages Management', 'everest-admin-theme-lite'); ?></div>
	</div>
	<div class="eat-tab-content-body">
		<div class="eat-options-wrap">
			<label for="eat-posts-pages-excerpt-box"><?php _e("Remove 'Excerpt' box?", "everest-admin-theme-lite"); ?></label>
		...
		<div class="eat-options-wrap">
			<label for="eat-posts-pages-category-box"><?php _e("Remove 'Category' box?", "everest-admin-theme-lite"); ?></label>
		...
		<div class="eat-options-wrap">
			<label for="eat-posts-pages-format-box"><?php _e("Remove 'Format' box?", "everest-admin-theme-lite"); ?></label>
		...
		<div class="eat-options-wrap">
			<label for="eat-posts-pages-trackback-box"><?php _e("Remove 'Trackbacks' box?", "everest-admin-theme-lite"); ?></label>
		...
		<div class="eat-options-wrap">
			<label for="eat-posts-pages-remove-comments-status-box"><?php _e("Remove 'Comments status' box?", "everest-admin-theme-lite"); ?></label>
		...
		<div class="eat-options-wrap">
			<label for="eat-posts-pages-comments-list"><?php _e("Remove 'Comments list' box?", "everest-admin-theme-lite"); ?></label>
		...
		<div class="eat-options-wrap">
			<label for="eat-posts-pages-custom-fields"><?php _e("Remove 'Custom Fields' box?", "everest-admin-theme-lite"); ?></label>
		...
		<div class="eat-options-wrap">
			<label for="eat-posts-pages-revisions-box"><?php _e("Remove 'Revisions' box?", "everest-admin-theme-lite"); ?></label>
		...
		<div class="eat-options-wrap">
			<label for="eat-posts-pages-author-box"><?php _e("Remove 'Author' box?", "everest-admin-theme-lite"); ?></label>
		...
		<div class="eat-options-wrap">
			<label for="eat-posts-pages-slug-box"><?php _e("Remove 'Slug' box?", "everest-admin-theme-lite"); ?></label>
