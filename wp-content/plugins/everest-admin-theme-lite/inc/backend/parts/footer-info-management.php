...
<div class="eat-tab-content eat-tab-footer-info-management" style="display: none;">
	<div class="eat-tab-content-header">
		<div class="eat-tab-content-header-title"><?php esc_html_e('Footer Info Management', 'everest-admin-theme-lite'); ?></div>
	</div>
	<div class="eat-tab-content-body">
		<div class="eat-options-wrap">
			<label for="eat-footer-info-hide-footer-completely"><?php _e( 'Hide footer Completely?', 'everest-admin-theme-lite' ); ?></label>
		...
		<div class="eat-default-footer-options-wrap">
			<div class="eat-deafult-footer-options-left">
				<div class="eat-style-label"><?php _e('Left footer settings?', 'everest-admin-theme-lite'); ?></div>
				<div class="eat-options-wrap">
					<label for="eat-footer-info-left-hide"><?php _e( 'Hide left footer completely?', 'everest-admin-theme-lite' ); ?></label>
				...
				<div class="eat-options-wrap">
					<label for="eat-footer-info-left-hide-default"><?php _e( 'Hide left footer default texts?', 'everest-admin-theme-lite' ); ?></label>
				...
				<div class="eat-custom-texts-options-wrap">
					<div class="eat-options-wrap">
						<label for="eat-footer-info-left-custom-texts-enable"><?php _e( 'Use custom texts?', 'everest-admin-theme-lite' ); ?></label>
					...
					<div class="eat-options-wrap eat-custom-texts-content-wrap" <?php if(isset($plugin_settings['footer_info']['left']['custom_texts']['enable'])){ echo "style='display:block;'"; }else{ echo "style='display:none;'"; } ?>>
						<label for="eat-footer-info-left-custom-texts-content"><?php _e( 'Custom texts', 'everest-admin-theme-lite' ); ?></label>
						<?php
						$settings = array(
							'media_buttons' => false,
				...
				<div class="eat-options-wrap">
					<label for="eat-footer-info-left-mysql-version-enable"><?php _e( 'Add mysql version?', 'everest-admin-theme-lite' ); ?></label>
				...
				<div class="eat-options-wrap">
					<label for="eat-hide-footer-left-php-version-enable"><?php _e( 'Add PHP version?', 'everest-admin-theme-lite' ); ?></label>
			...
			<div class="eat-deafult-footer-options-right">
				<div class="eat-style-label"><?php _e( 'Right Footer settings?', 'everest-admin-theme-lite' ); ?></div>
				<div class="eat-options-wrap">
					<label for="eat-footer-info-right-hide"><?php _e( 'Hide right footer completely?', 'everest-admin-theme-lite' ); ?></label>
				...
				<div class="eat-options-wrap">
					<label for="eat-footer-info-right-hide-default"><?php _e( 'Hide right footer default texts?', 'everest-admin-theme-lite' ); ?></label>
				...
				<div class="eat-custom-texts-options-wrap">
					<div class="eat-options-wrap">
						<label for="eat-footer-info-right-custom-texts-enable"><?php _e( 'Use custom texts?', 'everest-admin-theme-lite' ); ?></label>
					...
					<div class="eat-options-wrap eat-custom-texts-content-wrap" <?php if(isset($plugin_settings['footer_info']['right']['custom_texts']['enable'])){ echo "style='display:block;'"; }else{ echo "style='display:none;'"; } ?>>
						<label for="eat-footer-info-right-custom-texts-content"><?php _e( 'Custom texts', 'everest-admin-theme-lite' ); ?></label>
						<?php
						$settings = array(
							'media_buttons' => false,
				...
				<div class="eat-options-wrap">
					<label for="eat-footer-info-right-mysql-version-enable"><?php _e( 'Add mysql version?', 'everest-admin-theme-lite' ); ?></label>
				...
				<div class="eat-options-wrap">
					<label for="eat-hide-footer-right-php-version-enable"><?php _e( 'Add PHP version?', 'everest-admin-theme-lite' ); ?></label>
