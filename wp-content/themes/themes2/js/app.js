...
module.exports = global["window"]["Tether"] = __webpack_require__(24);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var map = {
	"./lib/jquery-ui.js": 16,
	"./lib/jquery.magnific-popup.js": 17,
	"./lib/jquery.matchHeight.js": 18,
	"./lib/jquery.parallax-1.1.3.js": 19,
	"./lib/ripple.min.js": 20,
	"./lib/slick.min.js": 21,
	"./lib/wow.js": 22,
	"./main.js": 23
};
...
//////////////////////////////////////////
var requireSCSS = __webpack_require__(12);
...
////////////////////
 var app = (function () {   
    ...
    _accordionHandlerTwo = function(){
          $('.accordion-blk .blk-two').on('click', function(){
              if(!$(this).hasClass('active')){
                   $('.accordion-blk .blk-two').removeClass('active');
                   $(".accordion-content").stop(true, true).slideUp();
                   $(this).addClass('active');
                   $(this).parents('.accordion-blk').find(".accordion-content").slideDown();
              }else{
        ...
        _rippleActions = function() {
         ...
         viewportCondition = function() {           
          $('.news-slider .slick-slide').matchHeight();
          var windowWidth = $(window).width();
          if(windowWidth < 769){
            $('.who-isit-slider, .news-slider').slick({              
              infinite: false,
              speed: 300,
              arrows: false,
              slidesToShow: 1,
          ...
          $('.render-blk').css("padding-bottom", footerHeight);
        },
...
if(Modernizr.touch){  
  ...
  //             }
  //         });
  $('.footer-columns .accordion-blk h6').on('click', function(){
              if(!$(this).hasClass('active')){
                   $('.accordion-blk h6').removeClass('active');
                   $(".accordion-content").stop(true, true).slideUp();
                   $(this).addClass('active');
                   $(this).parents('.accordion-blk').find(".accordion-content").slideDown();
              }else{
